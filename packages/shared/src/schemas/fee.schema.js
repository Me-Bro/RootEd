...
export const createFeeStructureSchema = feeStructureBaseSchema.refine(
  (v) => v.applicableTo !== 'class' || Boolean(v.classId),
  { message: 'classId required when applicableTo is class', path: ['classId'] }
);
